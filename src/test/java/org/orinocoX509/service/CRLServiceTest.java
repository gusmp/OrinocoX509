...
public class CRLServiceTest 
{
	...
	*/
	...
	public void generateAuthorityKeyIdentifierCRL(String profileName, Boolean critical, Boolean authorityKeyIdentifier, 
			Boolean authorityIssuerSerialNumber, String fileName)
	{
		...
		try
		{
			...
			{
				assertEquals(2, aki.getAuthorityCertSerialNumber().intValue());
			}
		}
		catch(Exception exc)
		{
	...
	public void generateCRLNumberCRL()
	{
		...
		try
		{
			...
			//ASN1InputStream asn1is = new ASN1InputStream(derOStr.getOctets());
			//System.out.println("CRL Number: " + new BigInteger(asn1is.readObject().toString()));
		}
		catch(Exception exc)
		{
			fail();
