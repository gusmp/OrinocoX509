...
public class TestConst
{
    ...
    // Check org\bouncycastle\asn1\x500\style\BCStyle.java for all available fields
    ...
    public static final String ISSUER_PATTERN = "C=ES, ST=Barcelona, L=Badalona, OU=CA de primer nivel, OU=ENTERPRISE.CV, CN=testCA";
    ...
    // Authority Key Identifier (change it if you CA changes!)
    public static final byte[] AUTHORITY_KEY_ID = {-12, -31, -90, -104, 74, -19, 86, -114, 43, -37, -52, 28, -110, -110, -33, -122, -91, -49, -8, -45};
    
    // Authority Key Identifier CRL (change it if you CA changes!)
    public static final BigInteger CA_SERIAL_NUMBER = new BigInteger("1024440260607901757"); 
    
    public static final String ROOT_SUBJECT = "C=ES,ST=Barcelona,L=Badalona,OU=CA de primer nivel,OU=ENTERPRISE.CV,CN=testCA";
    ...
    /*
     * NetscapeCertType ::= BIT STRING { SSLClient (0),
     * SSLServer (1),
     * S/MIME (2),
     * Object Signing (3),
     * Reserved (4),
    ...
    public static BigInteger SERIAL_NUMBER_REVOKED = new BigInteger("03778e", 16);

    public static byte[] VALID_EC_IDCAT_CERTIFICATE = Base64.decode("" + "MIIJXjCCCEagAwIBAgIDAv9mMA0GCSqGSIb3DQEBBQUAMIIBMTELMAkGA1UEBhMC" + "RVMxOzA5BgNVBAoTMkFnZW5jaWEgQ2F0YWxhbmEgZGUgQ2VydGlmaWNhY2lvIChO" + "SUYgUS0wODAxMTc2LUkpMTQwMgYDVQQHEytQYXNzYXRnZSBkZSBsYSBDb25jZXBj" + "aW8gMTEgMDgwMDggQmFyY2Vsb25hMS4wLAYDVQQLEyVTZXJ2ZWlzIFB1YmxpY3Mg" + "ZGUgQ2VydGlmaWNhY2lvIEVDVi0yMTUwMwYDVQQLEyxWZWdldSBodHRwczovL3d3" + "dy5jYXRjZXJ0Lm5ldC92ZXJDSUMtMiAoYykwMzE1MDMGA1UECxMsRW50aXRhdCBw" + "dWJsaWNhIGRlIGNlcnRpZmljYWNpbyBkZSBjaXV0YWRhbnMxETAPBgNVBAMTCEVD" + "LUlEQ2F0MB4XDTExMTEyNDE2MjE0M1oXDTE1MTEyMzE2MjE0M1owgfExCzAJBgNV" + "BAYTAkVTMTUwMwYDVQQLEyxWZWdldSBodHRwczovL3d3dy5jYXRjZXJ0LmNhdC92" + "ZXJpZENBVCAoYykwMzExMC8GA1UECxMoU2VydmVpcyBQdWJsaWNzIGRlIENlcnRp"
	    + "ZmljYWNpbyBDUElYU0EtMjEdMBsGA1UEBBQUREUgTEEgUEXHQSBERSBQUk9WRVMx" + "FzAVBgNVBCoTDlBFUlNPTkEgRklTSUNBMRIwEAYDVQQFEwkwMDAwMDAwMFQxLDAq" + "BgNVBAMUI1BFUlNPTkEgRklTSUNBIERFIExBIFBFx0EgREUgUFJPVkVTMIIBIjAN" + "BgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAjfupY+7O25Qwy/Hr5vr5GGe+3Gz1" + "laGvzyrw62L6spiKyDzLr/sUhYHz2QLbzAhTb/aKeX3tnPW1eqFbNHVaan+Hl9cX" + "M3wVQX4jKTXQq16kamXVaHORaDay6W6bj9VOGoxh4ZkSa215o7CoI8UtUMUrAxYo" + "iCGNWvGsPn3Duw//oQgyKBfbkYvfaWxulec8GOSuIg4EDLuSHgULxumy+JYmapPh" + "cvcjk6U6qytoWChz8UPrWHY9NMzpWsixifI6s69Hvja9dZ0CjBVs5L6XdSU7gwoC" + "pb4+ZqgTGYHjDcnPDTRCQy7C3/ckLhgMlUy+8/SZQFzWCGNG1dexTK7MfwIDAQAB" + "o4IEujCCBLYwDgYDVR0PAQH/BAQDAgXgMIGsBgNVHREEgaQwgaGBEmNvcnJldUBj" + "YXRjZXJ0LmNhdKSBijCBhzELMAkGA1UEBhMCRVMxKTAnBgNVBAoTIEFnZW5jaWEg"
	    + "Q2F0YWxhbmEgZGUgQ2VydGlmaWNhY2lvMQ4wDAYDVQQLEwVJRENBVDEPMA0GA1UE" + "BRMGMDJGRjY2MSwwKgYDVQQDFCNQRVJTT05BIEZJU0lDQSBERSBMQSBQRcdBIERF" + "IFBST1ZFUzAfBgNVHRIEGDAWgRRlY19pZGNhdEBjYXRjZXJ0Lm5ldDAdBgNVHQ4E" + "FgQUbhZ6LKzxTlIeemSmsjQ+88STK/swggExBgNVHSMEggEoMIIBJIAUzZLARUY0" + "dg3S9FuidB2rz2y2C7mhgfmkgfYwgfMxCzAJBgNVBAYTAkVTMTswOQYDVQQKEzJB" + "Z2VuY2lhIENhdGFsYW5hIGRlIENlcnRpZmljYWNpbyAoTklGIFEtMDgwMTE3Ni1J" + "KTEoMCYGA1UECxMfU2VydmVpcyBQdWJsaWNzIGRlIENlcnRpZmljYWNpbzE1MDMG" + "A1UECxMsVmVnZXUgaHR0cHM6Ly93d3cuY2F0Y2VydC5uZXQvdmVyYXJyZWwgKGMp" + "MDMxNTAzBgNVBAsTLEplcmFycXVpYSBFbnRpdGF0cyBkZSBDZXJ0aWZpY2FjaW8g" + "Q2F0YWxhbmVzMQ8wDQYDVQQDEwZFQy1BQ0OCEHBAQND9yjwZP6I8J2HqcM4wHQYD" + "VR0lBBYwFAYIKwYBBQUHAwIGCCsGAQUFBwMEMBEGCWCGSAGG+EIBAQQEAwIFoDBv"
	    + "BggrBgEFBQcBAQRjMGEwIwYIKwYBBQUHMAGGF2h0dHA6Ly9vY3NwLmNhdGNlcnQu" + "Y2F0MDoGCCsGAQUFBzAChi5odHRwOi8vd3d3LmNhdGNlcnQuY2F0L2Rlc2NhcnJl" + "Z2EvZWMtaWRjYXQuY3J0MCUGCCsGAQUFBwEDBBkwFzAIBgYEAI5GAQEwCwYGBACO" + "RgEDAgEPMGYGA1UdHwRfMF0wW6BZoFeGKWh0dHA6Ly9lcHNjZC5jYXRjZXJ0Lm5l" + "dC9jcmwvZWMtaWRjYXQuY3JshipodHRwOi8vZXBzY2QyLmNhdGNlcnQubmV0L2Ny" + "bC9lYy1pZGNhdC5jcmwwgfQGA1UdIASB7DCB6TCB5gYMKwYBBAH1eAEDAVYBMIHV" + "MCwGCCsGAQUFBwIBFiBodHRwczovL3d3dy5jYXRjZXJ0LmNhdC92ZXJpZENBVDCB" + "pAYIKwYBBQUHAgIwgZcagZRBcXVlc3QgZXMgdW4gY2VydGlmaWNhdCBwZXJzb25h" + "bCBpZENBVCwgcmVjb25lZ3V0IGQnaWRlbnRpZmljYWNpbywgc2lnbmF0dXJhIGkg" + "eGlmcmF0IGRlIGNsYXNzZSAyIGluZGl2aWR1YWwuIFZlZ2V1IGh0dHBzOi8vd3d3" + "LmNhdGNlcnQuY2F0L3ZlcmlkQ0FUMCgGCisGAQQB9XgBBAIEGhMYTm9uLUNyeXB0"
	    + "b2dyYXBoaWMgRGV2aWNlMC0GA1UdCQQmMCQwEAYIKwYBBQUHCQQxBBMCRVMwEAYI" + "KwYBBQUHCQUxBBMCRVMwDQYJKoZIhvcNAQEFBQADggEBAAOsPoOM/N3LpOozJdF4" + "KN2fOG/ESHg8RZUnpx1CE4J8Gw9m7D8rmpGR+onzbZV1QOzZLpPi2kwVS4n7ve/X" + "5uH2g2Js0kf1BofMPXyRjTwTJMNW9dKoMH0Ev6rt7xLeBLODaFeG4pfX5bdvI74S" + "evBdIqjiU1Jl5B3vM+2N+K8jaalodIjeFKha8kfhKIv1c6/c5Zu46HOqrzKB1iZA" + "YEONxSMP+ufb+iRZbkciEGdUTIrKkfzR42NkdYz3a6F7ABOCz82MX32kl9WA8cAK" + "eatB1QS41xzFpvDmZSPx5by3M3a0kVfoA2VPB8RmxAo4rCh0iY18KJC6LAIHLQx/" + "hhg=");
