...
public class SubjectAlternativeNameExtension implements EngineExtension
{
    ...
    public SubjectAlternativeNameExtension(BaseCertificateField certificateField, Map<String, String> certificateValues, VelocitySupport velocitySupport)
    {
    ...
    private GeneralName[] prepareAltNameExtensions(List<BaseCertificateFieldValue> altNameFields, Map<String, String> mapValues, String logTemplate)
    {
    ...
    {
	certificateGenerator.addExtension(X509Extension.subjectAlternativeName, certificateField.getCritical(), new GeneralNames(prepareAltNameExtensions(certificateField.getValues(), certificateValues, "SubjectalternativeName")));
