...
public class CertificateProfileServiceImpl implements CertificateProfileService 
{
	...
	public void validateProfile(CertificateProfile certificateProfile, CertificateValues certificateValues) throws EngineException
	{
	...
	{
		CertificateField field = profile.getField(fieldType); 
		if (field != null)
		{
	...
	private void checkValues(CertificateValues values, CertificateProfile profile) throws EngineException
	{
		if (values == null)
		{
