...
@Entity
@Table(name="CER_AUTHORITY_KEY_IDENTIFIER_FIELD_VALUE")
@Getter @Setter
@DiscriminatorValue(value=DiscriminatorValues.AUTHORITY_KEY_IDENTIFIER)
public class AuthorityKeyIdentifierFieldValue extends CertificateFieldValue 
{
	...
	{
		KEY_IDENTIFIER,
		AUTH_CERT_ISSUER_AUTH_CERT_SERIAL_NUMBER;
	}
