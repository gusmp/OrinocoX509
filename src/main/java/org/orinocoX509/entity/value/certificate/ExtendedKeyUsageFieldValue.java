...
@Entity
@Table(name="CER_EXTENDED_KEY_USAGE_FIELD_VALUE")
@Getter @Setter
@DiscriminatorValue(value=DiscriminatorValues.EXTENDED_KEY_USAGE)
public class ExtendedKeyUsageFieldValue extends CertificateFieldValue 
{
	...
	public static enum ExtendedKeyUsageType 
	{
		...
		ID_KP_TIME_STAMPING,
		ID_KP_OCSP_SIGNING,
		ID_KP_SMARTCARD_LOGON,
		ID_KP_CAP_WAP_AC,
		ID_KP_CAPWAPWTP,
		ID_KP_DVCS,
		ID_KP_EAP_OVER_LAN,
		ID_KP_EAP_OVER_PPP,
		ID_KP_IPSEC_ENDSYSTEM,
		ID_KP_IPSEC_IKE,
		ID_KP_IPSEC_TUNNEL,
		ID_KP_IPSEC_USER,
		ID_KP_SBGPCERTAA_SERVERAUTH,
