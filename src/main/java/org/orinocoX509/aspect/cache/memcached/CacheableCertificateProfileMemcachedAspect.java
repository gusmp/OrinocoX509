...
public class CacheableCertificateProfileMemcachedAspect
{
    ...
    @Pointcut("execution(* org.orinocoX509.service.CertificateProfileService.saveProfile(..)) || " + "execution(* org.orinocoX509.service.CertificateProfileService.deleteProfile(..)) ")
